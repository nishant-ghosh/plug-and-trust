...
SET(PTMW_PFSCP "None" CACHE STRING "Platform SCP default key set")
SET_PROPERTY(CACHE PTMW_PFSCP PROPERTY STRINGS "None;SE050A1;SE050A2;SE050B1;SE050B2;SE050C1;SE050C2;SE050_DEVKIT;SE051A2;SE051C2;SE050F2;SE051C_0005A8FA;SE051A_0001A920;SE050E_0001A921;A5000_0004A736;SE050F2_0001A92A;SE052_B501;OTHER")
...
FOREACH(_PFSCP_KEY_SET
    ...
    SE052_B501
    OTHER)
    SET(SSS_PFSCP_ENABLE_${_PFSCP_KEY_SET} "0")
ENDFOREACH()

IF(NOT "${PTMW_PFSCP}" STREQUAL "None")
    SET(SSS_PFSCP_ENABLE_${PTMW_PFSCP} "1")
ENDIF()
